...
alter table capstone.orders modify Order_Status varchar(100);
...
create table capstone.products (Product_id int Primary key, Product_name varchar(100), Brand_id int, Category_id int, ear int, List_price double);
...
select sum(i.quantity) as quantity , p.product_name
...
--- 10.
create table capstone.customer_segements(customer_id int,recency int,frequancy int,monetary decimal(12,2));
alter table capstone.customer_segements 
rename to capstone.customer_segments;

alter table capstone.customer_segements 
rename to capstone.customer_segments;


alter table capstone.customer_segments
